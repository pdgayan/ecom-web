  ...
  return (
    <div className="order-confirm">
      ...
      <div style={{ color: 'var(--muted)', fontSize: '0.85rem', marginBottom: '1rem' }}>
        <span>Status: </span>
        <strong style={{ color: 'var(--accent2)', textTransform: 'uppercase' }}>{order.status}</strong>
        &nbsp;·&nbsp;
      ...
      <div className="order-items-list card" style={{ padding: '1rem' }}>
        ...
        {order.items?.map(item => (
          <div key={item.productId} style={{ display: 'flex', justifyContent: 'space-between', padding: '0.4rem 0', fontSize: '0.87rem', borderBottom: '1px solid var(--border)' }}>
